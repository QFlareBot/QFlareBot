...
import { Blocks, FlaskConical, LayoutDashboard, LogOut, Moon, PanelsTopLeft, Settings, Sun } from 'lucide-vue-next'
  ...
  <div class="flex h-full flex-col md:flex-row">
    ...
    <header class="flex h-12 shrink-0 items-center justify-between border-b border-border bg-surface px-4 md:hidden">
      <span class="flex items-center gap-2 text-sm font-semibold text-fg">
        <span class="size-2 rounded-full" :class="status?.bot ? 'bg-success' : 'bg-warning'" aria-hidden="true" />qqbot
      </span>
